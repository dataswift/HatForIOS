...
Pod::Spec.new do |spec|
  ...
  spec.license      = "Mozilla Public License, v. 2.0"
  ...
  spec.source = { :git => "https://github.com/Hub-of-all-Things/HatForIOS.git", :tag => "#{spec.version}" }
  ...
  spec.exclude_files = "HAT/HAT/**/*.swift"
