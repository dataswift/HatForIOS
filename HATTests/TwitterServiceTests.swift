...
internal class TwitterServiceTests: XCTestCase {
    ...
    func testIsFacebookDataPlugActive() {
        ...
        let urlToConnect = "https://twitter.hubofallthings.com/api/status"
        ...
        HATTwitterService.isTwitterDataPlugActive(appToken: token, statusURL: urlToConnect, successful: completion, failed: failed)
