...
internal class HATGoogleCalendarTests: XCTestCase {
    ...
    func testGetGoogleData() {
        ...
        let urlToConnect: String = "https://testing.hubat.net/api/v2.6/data/calendar/google/events"
    ...
    func testGettingGoogleCalendarToken() {
        ...
        let urlToConnect: String = "https://\(userDomain)/users/application_token?name=Calendar&resource=calendar"
        
        let expectationTest: XCTestExpectation = expectation(description: "Getting app token for google calendar...")
