...
internal class SpotifyServiceTests: XCTestCase {
    ...
    func testGetSpotifyProfile() {
        ...
        let urlToConnect = "https://testing.hubat.net/api/v2.6/data/spotify/profile?orderBy=dateCreated&ordering=descending&take=1"
        ...
        let expectationTest = expectation(description: "Fetching spotify profile...")
